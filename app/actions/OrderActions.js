...
OrderActions.list.listen(function(type,state){
  ...
  var data = {
    State : s,
    Fields : 'Id,UserId,BuyerName,BuyerTel,Price,AppointedTime,PhotographerId,Photographer.BusinessPhone,IsSpecifiesAlbums,AlbumsId,CreationTime,State,Photographer.NickName,Photographer.Avatar,User.NickName,User.Avatar,User.UserId',
  };
  if(type == 'out')
